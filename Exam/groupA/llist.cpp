...
//  friend void reverseLList(LList<T1>&); //This is the declaration of the template friend function for the second solution of the task.
};
...
{ if (p == NULL)
  ...
  //We can replace the above 4 lines with only the line: deleteElem(it, x);
}
